...
from utils.bbox_utils import xywh2xyxy, bbox_iou
...
class GIoULoss(object):
    ...
    def bbox_overlap(self, box1, box2, eps=1e-10):
        ...
        """
        x1, y1, x2, y2 = paddle.unbind(box1, axis=1)
        x1g, y1g, x2g, y2g = paddle.unbind(box2, axis=1)
    ...
    def __call__(self, pbox, gbox, iou_weight=1., loc_reweight=None):
        iou, overlap, union = self.bbox_overlap(pbox, gbox, self.eps)
