...
class VisionStFusionTransformer(nn.Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.scene_text_feature_embeddings = nn.Linear(
            scene_text_feature_size, embed_dim
        )
    ...
    def forward(self, x, scene_text_features=None, scene_text_mask=None):
        ...
        x = self.forward_features(
            x, scene_text_features=scene_text_features, scene_text_mask=scene_text_mask
        )
        return x
