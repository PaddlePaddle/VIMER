...
parser.add_argument(
    ...
    default=512, 
    type=int,
    help="Image and text projection dim."
)
...
parser.add_argument(
    ...
    default=768,
    type=int,
    help="Text embedding dim."
)

parser.add_argument(
    "--scene_text_embed_dim", 
    default=768, 
    type=int,
    help="Scene Text embedding dim."
)
...
def main():
    ...
    for step, batch in enumerate(test_loader):
        ...
        if len(batch) == 4:
            ...
            image, input_ids, input_mask, segment_ids, scene_text_ids, \
                scene_text_mask, scene_text_segment_ids, fusion_mask = (batch)
        elif len(batch) == 9:
            image, input_ids, input_mask, segment_ids, scene_text_ids, \
                scene_text_mask, scene_text_segment_ids, fusion_mask, ocr_2D_pos = (batch)
        else:
    ...
    if args.feature_type == "scene_text" or args.feature_type == "both":
        ...
        np.save("{}_scene_text_features.npy".format(args.save_prefix), scene_text_features)
