...
from model.model_fusion import ITCL, networkselect
...
def main():
    ...
    if args.model_type == 'VL':
        ...
        if args.pre_training_model == "ITCL":
            model = ITCL(args)
        ...
        for step, batch in enumerate(test_loader):
            ...
            if args.feature_type == "image" or args.feature_type == "both" or args.feature_type == "itcl":
                image_embeds = image_embeds.detach().cpu().numpy()
                image_features.append(image_embeds)
            
            if args.feature_type == "text" or args.feature_type == "both" or args.feature_type == "itcl":
