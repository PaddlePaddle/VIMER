...
print("image queries %d, avg recall:%.4f, r1:%.4f, r5:%.4f, r10:%.4f, avg_rank:%.4f\n" % 
    (cnt, (r1+r5+r10)/(cnt*3), r1/cnt, r5/cnt, r10/cnt, idx_all/cnt))
