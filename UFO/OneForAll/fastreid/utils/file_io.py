...
class PathHandler:
    ...
    def _exists(self, path: str, **kwargs: Any):
        """
    ...
    def _isfile(self, path: str, **kwargs: Any):
        """
    ...
    def _isdir(self, path: str, **kwargs: Any):
        """
    ...
    def _ls(self, path: str, **kwargs: Any):
        """
    ...
    def _rm(self, path: str, **kwargs: Any):
        """
