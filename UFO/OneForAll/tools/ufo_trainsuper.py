    ...
    if "evaluator" in cfg.dataloader:
        ...
        for idx, (dataloader, evaluator_cfg) in enumerate(zip(dataloaders, cfg.dataloader.evaluator)):
            ...
            if isinstance(model, paddle.DataParallel):
                model._layers.subnet_mode = subnet_mode
            else:
                model.subnet_mode = subnet_mode
            ...
            for metric, res in ret.items():
                ...
                print('{}.{}.{} is {}'.format(task_name, dataset_name, metric, res))
        return rets
...
def do_train(args, cfg, cfg_for_sacred=None, _run=None):
    ...
    trainer.register_hooks(
        [
            ...
            hooks.EvalHook(cfg.train.eval_period, lambda: do_test(cfg, model, _run, subnet_mode="largest")),
            hooks.EvalHook(cfg.train.eval_period, lambda: do_test(cfg, model, _run, subnet_mode="smallest")),
